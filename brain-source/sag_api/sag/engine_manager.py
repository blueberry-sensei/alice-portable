...
def _database_time(value: datetime | None) -> datetime | None:
    """alicecore currently stores naive UTC datetimes in SQLite."""
...
def _utc_time(value: datetime | None) -> datetime | None:
    """Normalize alicecore's naive SQLite timestamps at the API boundary."""
    if value is None:
        return None
...
class _EngineLifecycleGate:
    """Writer-preferring async gate around alicecore's shared runtime reset."""
...
class EngineManager:
    ...
    async def _ensure_universe_query_indexes(self) -> None:
        ...
        try:
            ...
            from alicecore.db import get_engine
            from alicecore.db.models import EventEntity, SourceEvent
    ...
    async def _ensure_source_config(
        ...
        """Ensure the alicecore parent row exists before derived data is written.
    ...
    async def search_event_scores(
        ...
        *,
        ...
        from alicecore.core.storage.client import get_es_client
        from alicecore.core.storage.repositories.event_repository import (
    ...
    async def graph_for_sections(
        ...
        *,
        ...
        from alicecore.db.models import Entity, EventEntity, SourceEvent
    ...
    async def universe_timeline(
        ...
        *,
        ...
        from sqlalchemy import and_, func, or_, select
        from alicecore.db import get_session_factory
        from alicecore.db.models import SourceEvent
    ...
    async def universe_node_detail(
        ...
        *,
        ...
        from sqlalchemy import select
        from alicecore.db import get_session_factory
        from alicecore.db.models import Entity, SourceEvent
    ...
    async def list_chunk_headings(
        ...
        *,
        ...
        from sqlalchemy import select
        from alicecore.db import get_session_factory
        from alicecore.db.models import SourceChunk
    ...
    async def get_document_markdown(
        ...
        *,
        ...
        from sqlalchemy import select
        from alicecore.db import get_session_factory
        from alicecore.db.models import Article
