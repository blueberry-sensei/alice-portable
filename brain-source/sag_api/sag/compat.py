"""Compatibility shims for dependency-owned alicecore behavior.
...
def install_engine_extract_compat() -> None:
    ...
    alicecore validates these fields before its parser can use the extracted
    ...
    compatible defaults before alicecore's own output validator runs.
    """
